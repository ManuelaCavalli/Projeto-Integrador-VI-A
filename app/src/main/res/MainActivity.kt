    ...
    private fun initializeBricks() {
        ...
        for (row in 0 until brickRows) {
            ...
            for (col in 0 until brickColumns) {
                ...
                when (row) {
                    0 -> brick.setBackgroundColor(Color.RED)
                    1 -> brick.setBackgroundColor(Color.rgb(255, 165, 0))
                    2 -> brick.setBackgroundColor(Color.YELLOW)
                    3 -> brick.setBackgroundColor(Color.GREEN)
                    4 -> brick.setBackgroundColor(Color.CYAN)
                    5 -> brick.setBackgroundColor(Color.BLUE)
                    6 -> brick.setBackgroundColor(Color.MAGENTA)
                    7 -> brick.setBackgroundColor(Color.RED)
                    8 -> brick.setBackgroundColor(Color.YELLOW)
                }
